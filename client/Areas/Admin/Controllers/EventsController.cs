...
namespace client.Areas.Admin.Controllers
{
    ...
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EventId,Name,Description,Active,Date,Program,DateEnd,MaxVisitors,MaxVisitorsVip")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventId,Name,Description,Active,Date,Program,DateEnd,MaxVisitors,MaxVisitorsVip")] Event @event)
        {
            if (id != @event.EventId)
            {
                return NotFound();
