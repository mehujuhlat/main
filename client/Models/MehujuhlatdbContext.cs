...
public partial class MehujuhlatdbContext : DbContext
{
    public MehujuhlatdbContext()
    {
    }

    public MehujuhlatdbContext(DbContextOptions<MehujuhlatdbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Pticket>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.Ptickets)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PTickets__UserID__6B24EA82");
        });
